...
public class BasePickerView {
    ...
    protected int pickerview_timebtn_nor = 0xFFFFFFFF;
    protected int pickerview_timebtn_pre = 0xFFc2daf5;
    protected int pickerview_bg_topbar = 0xFF4d5050;
    protected int pickerview_topbar_title = 0xFFFFFFFF;
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.NormalDialog);
