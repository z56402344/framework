...
public class FlowLayout extends ViewGroup {
    ...
    private boolean mIsOverLay;//布局大小固定之后是否重叠
    public int mLineWd;
    public int mChildRightMargin;
    ...
    public void setOverLay(boolean o){
        mIsOverLay = o;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < this.getChildCount(); i++) {
            ...
            if (lineUsed + spaceWidth > widthSize) {
                ...
                mLineWd = spaceWidth *i;
                mChildRightMargin = mlp.rightMargin;
                if (!mIsOverLay)lineY += lineHeight + mLineSpacing;
