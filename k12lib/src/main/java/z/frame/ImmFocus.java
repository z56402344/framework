...
//		if (mLastFocus!=null) {
//			InputMethodManager imm = (InputMethodManager)mLastFocus.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
//				boolean keep = (imm.isActive());
//				boolean hide = imm.hideSoftInputFromWindow(mLastFocus.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
//				_log("active="+keep+",hide="+hide);
//				if (!(mLastFocus instanceof EditText)||!keep) mLastFocus = null;
//				if (!keep) mLastFocus = null;
//			if (!imm.hideSoftInputFromWindow(mLastFocus.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS)||!(mLastFocus instanceof TextView)) {
//				mLastFocus = null;
//			}
//		}
	}
...
//			InputMethodManager imm = (InputMethodManager)mLastFocus.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
//			imm.showSoftInput(mLastFocus, 0);
			mLastFocus = null;
		}
	}
	// 预约焦点
